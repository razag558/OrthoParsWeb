...
namespace rstemenu
{
    public partial class Lower_Crowding_Mixed : System.Web.UI.Page
    {
        int step1 = 6;
        int step2 = 6;
        int step3 = 6;
        ...
        public void Calculations()
        {
            ...
            if (Convert.ToString(Session["Preorposttreatment"]) == "Pretreatment")
            {
                ...
                Session["pre_lower_anter_segment_type_definer"] = "Mixed";
            ...
            else if (Convert.ToString(Session["Preorposttreatment"]) == "Posttreatment")
            {
                ...
                Session["post_lower_anter_segment_type_definer"] = "Mixed";
            }
        ...
        {
            if (Convert.ToString(Session["Preorposttreatment"]) == "Pretreatment" &&
                Convert.ToString(Session["pre_lower_anter_segment_type_definer"]) == "Mixed")
            {
                //step1 
                {
                ...
                Convert.ToString(Session["post_lower_anter_segment_type_definer"]) == "Mixed")
            {
                //step1 
                {
