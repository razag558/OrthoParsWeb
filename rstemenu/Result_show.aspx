...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="text-left" style="width: 85%;">
        ...
        <br />
        <asp:Label Visible="false" runat="server" Text="5.	PAR nomogram: Please visually plot P1 score on the X axis and P2 score on the Y axis of the PAR nomograph below to identify the treatment outcome based on the intersection of the visualised x and y point." Font-Size="18px" ID="momogram"></asp:Label>
        <br />
