...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="Doctor_muhammad_bio.aspx">
                    <img src="images/Doctor_Muhammad.jpeg" class="img-circle" alt="Muhammad" style="width: 50%;">
                </a>
            </div>
            <div class="column text-center">
                <a href="Doctor_Haris_bio.aspx">
                    <img src="images/doctor_haris.png" alt="Haris" class="img-circle" style="width: 50%;">
                </a>
            </div>
    ...
    <div class="text-center" runat="server" style="margin-top: 5%;">
        ...
        <div class="container" style="margin-top:10px;">
         <asp:Button ID="Button1" runat="server" Text="Promotion" Width="60%"  OnClick="MoveToPromotion" CssClass="btn btn-primary btn-lg"  />   
        </div>
