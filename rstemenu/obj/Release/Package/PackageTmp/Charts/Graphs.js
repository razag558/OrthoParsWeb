            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    DaySession = "Monthly";
                        while (count > 0) {
                            LabelResult[counter] = [JsonString[counter].weekdays];
                            DataResult[counter] = parseFloat(Math.round([JsonString[counter].total] * 100) / 100).toFixed(0);
                            counter++;
                            count--;
                        }
                    }
                   ...
                   // alert('custom' + Session);
                        while (count > 0) {
                            LabelResult[counter] = [JsonString[counter].monthNames];
                            DataResult[counter] = parseFloat(Math.round([JsonString[counter].totalAmount] * 100) / 100).toFixed(0);
                            counter++;
                            count--;
                        }
                    }
...
//                                                    if(value > 999)
 //                                                       return "£" + Math.round(value/1024).toFixed(1) + "K";
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    DaySession = SessionDate;
                        while (count > 0) {
                            LabelResult[counter] = [JsonString[counter].monthNames];
                            DataResult[counter] = parseFloat(Math.round([JsonString[counter].totalAmount] * 100) / 100).toFixed(2);
                            counter++;
                            count--;
                        }
