<%@ Page Title="" Language="C#" MasterPageFile="~/sadmin.Master" AutoEventWireup="true" CodeBehind="LowerCrowding.aspx.cs" Inherits="rstemenu.LowerCrowding" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div  class="container "  style="width:100%;    margin-top:20px;   "  >
         <div   class="well" style="text-align:center;">
          ...
          <asp:Label  Text="Contact points displacement between UR3 and UR2"   runat="server"  Style=" width:100%;  color:blue;  font-size:large;  " />
    ...
    <div class="container" >
        ...
        <div class="row  " >
                             <div class="col-sm-4  " >
                                                                  ...
                                                                  <a href="helppage.aspx?id=3&heading=lowr3r20"> <span  style="margin-left:15px;" class="glyphicon glyphicon-info-sign"></span> </a>
                                          </div>
                                  

                             <div class="col-sm-4   " >
                                          
                                                         <asp:RadioButton ID="crowding_lower_right_1_s1" Text="Score 1" runat="server"  GroupName="crowding_lower_right_1"/> 

                                                  
                                                           <a href="helppage.aspx?id=4&heading=lowr3r21" > <span style="margin-left:15px;" class="glyphicon glyphicon-info-sign"></span> </a>
                                                     </div>
           

            <div class="col-sm-4   " >
                                          
                                                         <asp:RadioButton ID="crowding_lower_right_1_s2" Text="Score 2" runat="server" GroupName="crowding_lower_right_1" /> 

                                                  
                                                           <a href="helppage.aspx?id=5&heading=lowr3r22" > <span style="margin-left:15px;" class="glyphicon glyphicon-info-sign"></span> </a>
                                                     </div>
             </div>
            ...
            <div class="col-sm-4   " >
                                                         ...
                                                         <asp:RadioButton ID="crowding_lower_right_1_s3" Text="Score 3" runat="server" GroupName="crowding_lower_right_1" /> 

                                                  
                                                           <a href="helppage.aspx?id=6&heading=lowr3r23" > <span style="margin-left:15px;" class="glyphicon glyphicon-info-sign"></span> </a>
                                                     </div>
            <div class="col-sm-4   " >
                                          
                                                         <asp:RadioButton ID="crowding_lower_right_1_s4" Text="Score 4" runat="server" GroupName="crowding_lower_right_1" /> 

                                                  
                                                           <a href="helppage.aspx?id=7&heading=lowr3r24" > <span style="margin-left:15px;" class="glyphicon glyphicon-info-sign"></span> </a>
                                                     </div>
            ...
            <div class="col-sm-4   " >
                                                         ...
                                                         <asp:RadioButton ID="crowding_lower_right_1_s5" Text="Score 5" runat="server" GroupName="crowding_lower_right_1" /> 
                                                           ...
                                                           <a href="helppage.aspx?id=8&heading=lowr3r25" > <span style="margin-left:15px;" class="glyphicon glyphicon-info-sign"></span> </a>
                                                     </div>
    ...
    <div  class="container "  style="width:100%;    margin-top:20px;   "  >
         <div   class="well" style="text-align:center;">
          ...
          <asp:Label  Text="Contact points displacement between UR2 and UR1"   runat="server"  Style=" width:100%;  color:blue;  font-size:large;  " />
        ...
        <div  class="container "  style="width:100%;    margin-top:20px;   "  >
         <div   class="well" style="text-align:center;">
          ...
          <asp:Label  Text="Contact Points displacement between UR1 and UL1"   runat="server"  Style=" width:100%;  color:blue;  font-size:large;  " />
        ...
        <div class="row  " >
         ...
         <div   class="well" style="text-align:center;">
          ...
          <asp:Label  Text="Contact points displacement between UL2 and UL1"   runat="server"  Style=" width:100%;  color:blue;  font-size:large;  " />
    ...
    <div  class="container "  style="width:100%;    margin-top:20px;   "  >
         <div   class="well" style="text-align:center;">
          ...
          <asp:Label  Text="Contact points displacement between UL3 and UL2"   runat="server"  Style=" width:100%;  color:blue;  font-size:large;  " />
        ...
        <div class="row justify-content-center" >
                             <div class="col-sm-4  " >
                                                                  ...
                                                                  <a href="helppage.aspx?id=3&heading=lowl3l20"> <span class="glyphicon glyphicon-info-sign"></span> </a>
                                          </div>
                                  

                             <div class="col-sm-4   " >
                                          
                                                         <asp:RadioButton ID="crowding_lower_left_2_s1" Text="Score 1" runat="server" GroupName="crowding_lower_left_2" /> 

                                                  
                                                           <a href="helppage.aspx?id=4&heading=lowl3l21" > <span class="glyphicon glyphicon-info-sign"></span> </a>
                                                     </div>
           

            <div class="col-sm-4   " >
                                          
                                                         <asp:RadioButton ID="crowding_lower_left_2_s2" Text="Score 2" runat="server"  GroupName="crowding_lower_left_2"/> 

                                                  
                                                           <a href="helppage.aspx?id=5&heading=lowl3l22" > <span class="glyphicon glyphicon-info-sign"></span> </a>
                                                     </div>
             </div>
            ...
            <div class="col-sm-4   " >
                                                         ...
                                                         <asp:RadioButton ID="crowding_lower_left_2_s3" Text="Score 3" runat="server" GroupName="crowding_lower_left_2" /> 

                                                  
                                                           <a href="helppage.aspx?id=6&heading=lowl3l23" > <span class="glyphicon glyphicon-info-sign"></span> </a>
                                                     </div>
            <div class="col-sm-4   " >
                                          
                                                         <asp:RadioButton ID="crowding_lower_left_2_s4" Text="Score 4" runat="server" GroupName="crowding_lower_left_2" /> 

                                                  
                                                           <a href="helppage.aspx?id=7&heading=lowl3l24" > <span class="glyphicon glyphicon-info-sign"></span> </a>
                                                     </div>
            ...
            <div class="col-sm-4   " >
                                                         ...
                                                         <asp:RadioButton ID="crowding_lower_left_2_s5" Text="Score 5" runat="server"  GroupName="crowding_lower_left_2"/> 
                                                           ...
                                                           <a href="helppage.aspx?id=8&heading=lowl3l25" > <span class="glyphicon glyphicon-info-sign"></span> </a>
                                                     </div>
            ...
            <div class="container" style="text-align:end; margin-top:15px;" > 
                 ...
                 <asp:Label runat="server" Visible="false" ID="showing_error" Width="100%" CssClass="text-danger" Text="Please Complete all domains to Continue"  />

    
            <asp:Button CssClass="btn btn-primary" Text="SUBMIT" ID="submit_lower_right" runat="server" OnClick="submit_lower_right_Click" />
         </div>
